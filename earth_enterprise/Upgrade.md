...
If you decide that you want to uninstall GEE 5.2.x before installing GEE 5.2.4,
first make sure to backup your PostgreSQL databases. Please keep in mind that
the database backup, made by 5.2.x, would not be compatible with GEE 5.2.4
